<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherPageProjDec.aspx.cs" Inherits="Etap3_WebPage_Dziennik.TeacherPageProjDec" %>
...
<body>
    <form id="form1" runat="server">
        ...
        &nbsp;</span></strong><span class="auto-style11">[Projects declaration]</span><strong><br />
            </strong>
        </div>
            ...
            <tr>
                <td class="auto-style2">
                    <table align="left" class="auto-style3">
                        ...
                        <tr>
                            <td class="auto-style4">
                                <asp:Button ID="ButtonProjDec" runat="server" OnClick="ButtonProjDec_Click1" Text="Projects declaration" Width="200px" BackColor="#99FF99" />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style4">
