<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherPageProjects.aspx.cs" Inherits="Etap3_WebPage_Dziennik.TeacherPageProjects" %>
...
<body>
    <form id="form1" runat="server">
        ...
        &nbsp;</span></strong><span class="auto-style11">[Projects]</span><strong><br />
            </strong>
        </div>
            ...
            <tr>
                <td class="auto-style2">
                    <table align="left" class="auto-style3">
                        ...
                        <tr>
                            <td class="auto-style4">
                                <asp:Button ID="ButtonProjects" runat="server" Text="Projects" Width="200px" OnClick="ButtonProjects_Click" BackColor="#99FF99" />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style4">
