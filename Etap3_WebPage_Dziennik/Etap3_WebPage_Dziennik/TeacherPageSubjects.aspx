<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherPageSubjects.aspx.cs" Inherits="Etap3_WebPage_Dziennik.TeacherPageSubjects" %>
...
<body>
    <form id="form1" runat="server">
        ...
        &nbsp;</span></strong><span class="auto-style11">[Subjects]</span><strong><br />
            </strong>
        </div>
            ...
            <tr>
                <td class="auto-style2">
                    <table align="left" class="auto-style3">
                        ...
                        <tr>
                            <td class="auto-style4">
                                <asp:Button ID="ButtonSubjects" runat="server" Text="Subjects" Width="200px" OnClick="ButtonSubjects_Click" BackColor="#99FF99" />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style4">
